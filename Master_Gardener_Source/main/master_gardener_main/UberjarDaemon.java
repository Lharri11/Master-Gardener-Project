...
public class UberjarDaemon implements IDaemon {
	...
	public void start(String instanceName) {
		...
		try {
			...
			System.out.println("Error creating instance-specific temp dir: " + e.getMessage());
			System.out.println("Webapp files will be placed in default temp dir " + System.getProperty("java.io.tmpdir"));
		}
	...
	public void shutdown() {
		...
		if (tmpdir != null) {
			try {
				...
				System.out.println("Error deleting temp directory: " + e.getMessage());
			}
		}
	}
}

...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-6 offset-sm-3">
            <p class="text-xs-center">Use the form below to change your password. Your password cannot be the same as your
                username.</p>
            <form method="post" id="passwordForm">
                <input type="password" class="form-control-lg form-control" name="password1" id="password1"
                ...
                <input type="password" class="form-control-lg form-control" name="password2" id="password2"

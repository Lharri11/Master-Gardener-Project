                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    >This Dataform is for the garden</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group" style="display: block;">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" data-role="select"
                                                        selected="selected"
                                                        name="plant[1]Strain[1]Plot[1]BloomsOpen">
                                                    <option value=""></option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group" style="display: block;">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" data-role="select"
                                                        selected="selected"
                                                        name="plant[1]Strain[2]Plot[2]BloomsOpen">
                                                    <option value=""></option>
                                                    <option value="E">Early</option>
                                                    <option value="P">Peak</option>
                                                    <option value="F">Faded</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group" style="display: block;">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" data-role="select"
                                                        selected="selected"
                                                        name="plant[1]Strain[3]Plot[3]BloomsOpen">
                                                    <option value=""></option>
                                                    <option value="E">Early</option>
                                                    <option value="P">Peak</option>
                                                    <option value="F">Faded</option>
